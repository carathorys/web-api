...
export type IncludePropertyKeys<T, U> = { [P in keyof T]: T[P] extends U ? P : never }[keyof T];
/** Excludes property keys from T where the property is assignable to U */
export type ExcludePropertyKeys<T, U> = { [P in keyof T]: T[P] extends U ? never : P }[keyof T];

/** Includes properties from T where the property is assignable to U */
export type IncludePropertyTypes<T, U> = { [K in IncludePropertyKeys<T, U>]: T[K] };
/** Excludes properties from T where the property is assignable to U */
export type ExcludePropertyTypes<T, U> = { [K in ExcludePropertyKeys<T, U>]: T[K] };

/** Makes properties of type T optional where the property is assignable to U */
export type OptionalPropertyType<T, U> = ExcludePropertyTypes<T, U> & Partial<IncludePropertyTypes<T, U>>;
/** Makes properties of type T readonly where the property is assignable to U */
export type ReadonlyPropertyType<T, U> = ExcludePropertyTypes<T, U> & Readonly<IncludePropertyTypes<T, U>>;
