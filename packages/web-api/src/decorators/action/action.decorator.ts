import { ParameterMetadata, ParameterMetadataKey, ParameterType } from '../parameter';
...
export const Action: (params?: ActionParameter) => MethodDecorator = (params?: ActionParameter) => {
  return (target: any, propertyKey: string | Symbol, descriptor: PropertyDescriptor) => {
    ...
    parameters = parameters.sort((a, b) => a.parameterIndex > b.parameterIndex ? 1 : a.parameterIndex == b.parameterIndex ? 0 : -1);
